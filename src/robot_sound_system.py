...
# -------------------- FUNCTIONS --------------------
def victory_jingle():
    measure1 = [E6, A7, A7, C7, C7, A7_2X, E6, E6, E6_3HALVES, E6_HALF, B7_HALF, A7_HALF, G6_HALF, F6_HALF, E6_3X, E6,
                A7, A7, C7, C7, A7_2X, E6, A7, G6, F6_HALF, G6_HALF, A7, D6, E6_3X, E6, G6, G6, A7_HALF, G6_HALF,
                F6_HALF, G6_HALF, A7_2X, E6, A7, G6, G6, G6_HALF, D7_HALF, B7_HALF, G6_HALF, A7_3X, A7, F6, F6, F6, A7,
                A7_2X, E6, E6, E6_3HALVES, E6_HALF, B7, G6, A7_3X, A7, G6_HALF, F6_HALF, F6, F6_HALF, A7_HALF, G6_HALF,
                B7_HALF, A7_2X, E6, E6, E6_3HALVES, E6_HALF, B7, G6, A7_3X]
    song1 = Song(measure1)
    song1.compile()
    song1.play()
    song1.wait_done()
